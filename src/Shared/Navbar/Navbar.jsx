  ...
  return (
    <div className="flex items-center justify-between gap-3 md:gap-80 mt-4 mx-3 md:mx-0">
      ...
      <button
        ...
        className="relative inline-flex items-center justify-center p-2 px-6 py-2 md:p-4  md:py-3 overflow-hidden font-medium text-indigo-600 transition duration-300 ease-out border-2 border-[#015597] rounded-full shadow-md group"
      >
